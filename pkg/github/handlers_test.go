...
func Test_handleRepoExist(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			fields: fields{
				method:    "Repositories",
				arguments: []interface{}{"your-ko", "link-validator"},
				result:    []interface{}{&github.Repository{Name: github.Ptr("link-validator")}, (*github.Response)(nil), nil},
			},
		},
		{
			...
			fields: fields{
				method:    "Repositories",
				arguments: []interface{}{"contributor", "link-validator"},
				result:    []interface{}{&github.Repository{Name: github.Ptr("link-validator")}, (*github.Response)(nil), nil},
			},
		},
		{
			...
			fields: fields{
				method:    "Repositories",
				arguments: []interface{}{"your-ko", "nonexistent-repo"},
				result:    []interface{}{(*github.Repository)(nil), (*github.Response)(nil), errors.New("404 not found")},
			},
			wantErr: true,
		},
		{
			...
			fields: fields{
				method:    "Repositories",
				arguments: []interface{}{"nonexistent-user", "some-repo"},
				result:    []interface{}{(*github.Repository)(nil), (*github.Response)(nil), errors.New("404 not found")},
			},
			wantErr: true,
		},
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			client := new(MockClient)
			params := append([]interface{}{mock.Anything}, tt.fields.arguments...)
			client.On(tt.fields.method, params...).
				Return(tt.fields.result...).
				Once()

			err := handleRepoExist(context.Background(), client, tt.args.owner, tt.args.repo, tt.args.ref, tt.args.path, tt.args.fragment)

			client.AssertExpectations(t)
			if err == nil && tt.wantErr {
				if tt.wantIs != nil {
					t.Fatalf("Got nothing but expected error '%s'", tt.wantIs)
				}
				t.Fatalf("Got nothing but expected error")
			}
			if (err != nil) && !tt.wantErr {
