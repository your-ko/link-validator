	...
	}{
		{
			...
			setupMock: func(m *mockclient) {
				repo := &github.Repository{
					ID:       new(int64(123)),
					Name:     new("link-validator"),
					FullName: new("your-ko/link-validator"),
					Private:  new(false),
					Owner: &github.User{
						Login: new("your-ko"),
					},
		...
		},
		{
			...
			setupMock: func(m *mockclient) {
				repo := &github.Repository{
					ID:       new(int64(123)),
					Name:     new("link-validator"),
					FullName: new("contributor/link-validator"),
					Fork:     new(true),
					Private:  new(false),
					Owner: &github.User{
...
func Test_handleCommit(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args: args{"your-ko", "link-validator", "", "", ""},
			setupMock: func(m *mockclient) {
				commit := &github.RepositoryCommit{SHA: new("1234567890")}
				resp := &github.Response{Response: &http.Response{StatusCode: http.StatusOK}}
				repo := &github.Repository{Name: new("link-validator")}
				m.EXPECT().getRepository(mock.Anything, "your-ko", "link-validator").Return(repo, resp, nil)
		...
		},
		{
			...
			setupMock: func(m *mockclient) {
				commit := &github.RepositoryCommit{SHA: new("a96366f66ffacd461de10a1dd561ab5a598e9167")}
				resp := &github.Response{Response: &http.Response{StatusCode: http.StatusOK}}
				repo := &github.Repository{Name: new("link-validator")}
				m.EXPECT().getRepository(mock.Anything, "your-ko", "link-validator").Return(repo, resp, nil)
...
func Test_handlePull(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			setupMock: func(m *mockclient) {
				pr := &github.PullRequest{Title: new("great PR")}
				resp := &github.Response{Response: &http.Response{StatusCode: http.StatusOK}}
				repo := &github.Repository{Name: new("link-validator")}
				m.EXPECT().getRepository(mock.Anything, "your-ko", "link-validator").Return(repo, resp, nil)
		...
		},
		{
			...
			setupMock: func(m *mockclient) {
				pr := &github.PullRequest{Title: new("great PR")}
				comment := &github.IssueComment{Body: new("comment")}
				resp := &github.Response{Response: &http.Response{StatusCode: http.StatusOK}}
				repo := &github.Repository{Name: new("link-validator")}
				m.EXPECT().getRepository(mock.Anything, "your-ko", "link-validator").Return(repo, resp, nil)
				m.EXPECT().getPR(mock.Anything, "your-ko", "link-validator", 1).Return(pr, resp, nil)
		...
		},
		{
			...
			setupMock: func(m *mockclient) {
				pr := &github.PullRequest{Title: new("great PR")}
				comment := &github.PullRequestComment{Body: new("comment")}
				resp := &github.Response{Response: &http.Response{StatusCode: http.StatusOK}}
				repo := &github.Repository{Name: new("link-validator")}
				m.EXPECT().getRepository(mock.Anything, "your-ko", "link-validator").Return(repo, resp, nil)
				m.EXPECT().getPR(mock.Anything, "your-ko", "link-validator", 1).Return(pr, resp, nil)
...
func Test_handleMilestone(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args: args{"your-ko", "link-validator", "1", "", ""},
			setupMock: func(m *mockclient) {
				milestone := &github.Milestone{Title: new("great milestone")}
				resp := &github.Response{Response: &http.Response{StatusCode: http.StatusOK}}
				repo := &github.Repository{Name: new("link-validator")}
				m.EXPECT().getRepository(mock.Anything, "your-ko", "link-validator").Return(repo, resp, nil)
...
func Test_handleSecurityAdvisories(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			setupMock: func(m *mockclient) {
				sa := []*github.SecurityAdvisory{{
					GHSAID:  new("GHSA-1234-5678-9012"),
					Summary: new("be secure"),
				}}
				resp := &github.Response{Response: &http.Response{StatusCode: http.StatusOK}}
				repo := &github.Repository{Name: new("link-validator")}
				m.EXPECT().getRepository(mock.Anything, "your-ko", "link-validator").Return(repo, resp, nil)
		...
		},
		{
			...
			setupMock: func(m *mockclient) {
				sa := []*github.SecurityAdvisory{{
					GHSAID:  new("GHSA-0000-0000-0000"),
					Summary: new("be secure"),
				}}
				resp := &github.Response{Response: &http.Response{StatusCode: http.StatusOK}}
				repo := &github.Repository{Name: new("link-validator")}
...
func Test_handleWorkflow(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			setupMock: func(m *mockclient) {
				workflow := &github.Workflow{Name: new("pr.yaml")}
				resp := &github.Response{Response: &http.Response{StatusCode: http.StatusOK}}
				repo := &github.Repository{Name: new("link-validator")}
				m.EXPECT().getRepository(mock.Anything, "your-ko", "link-validator").Return(repo, resp, nil)
		...
		},
		{
			...
			setupMock: func(m *mockclient) {
				workflow := &github.WorkflowRun{Name: new("pr.yaml")}
				resp := &github.Response{Response: &http.Response{StatusCode: http.StatusOK}}
				repo := &github.Repository{Name: new("link-validator")}
				m.EXPECT().getRepository(mock.Anything, "your-ko", "link-validator").Return(repo, resp, nil)
		...
		},
		{
			...
			setupMock: func(m *mockclient) {
				job := &github.WorkflowJob{Name: new("pr.yaml")}
				resp := &github.Response{Response: &http.Response{StatusCode: http.StatusOK}}
				repo := &github.Repository{Name: new("link-validator")}
				m.EXPECT().getRepository(mock.Anything, "your-ko", "link-validator").Return(repo, resp, nil)
		...
		},
		{
			...
			setupMock: func(m *mockclient) {
				jobs := &github.Jobs{TotalCount: new(5)}
				resp := &github.Response{Response: &http.Response{StatusCode: http.StatusOK}}
				repo := &github.Repository{Name: new("link-validator")}
				m.EXPECT().getRepository(mock.Anything, "your-ko", "link-validator").Return(repo, resp, nil)
		...
		},
		{
			...
			args: args{"your-ko", "link-validator", "runs", "1234567890/attempts/2", ""},
			setupMock: func(m *mockclient) {
				jobs := &github.Jobs{TotalCount: new(1)}
				resp := &github.Response{Response: &http.Response{StatusCode: http.StatusOK}}
				repo := &github.Repository{Name: new("link-validator")}
				m.EXPECT().getRepository(mock.Anything, "your-ko", "link-validator").Return(repo, resp, nil)
				m.EXPECT().listWorkflowJobsAttempt(mock.Anything, "your-ko", "link-validator", int64(1234567890), int64(2), (*github.ListOptions)(nil)).Return(jobs, resp, nil)
...
func Test_handleUser(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args: args{"your-ko", "", "", "", ""},
			setupMock: func(m *mockclient) {
				user := &github.User{Name: new("your-ko")}
				resp := &github.Response{Response: &http.Response{StatusCode: http.StatusOK}}
...
func Test_handleIssue(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			args: args{"your-ko", "link-validator", "1", "", ""},
			setupMock: func(m *mockclient) {
				issue := &github.Issue{Title: new("super issue")}
				resp := &github.Response{Response: &http.Response{StatusCode: http.StatusOK}}
				repo := &github.Repository{Name: new("link-validator")}
				m.EXPECT().getRepository(mock.Anything, "your-ko", "link-validator").Return(repo, resp, nil)
...
func Test_handleReleases(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			setupMock: func(m *mockclient) {
				release := &github.RepositoryRelease{Name: new("cool release")}
				resp := &github.Response{Response: &http.Response{StatusCode: http.StatusOK}}
				repo := &github.Repository{Name: new("link-validator")}
				m.EXPECT().getRepository(mock.Anything, "your-ko", "link-validator").Return(repo, resp, nil)
		...
		},
		{
			...
			setupMock: func(m *mockclient) {
				release := &github.RepositoryRelease{
					Name:   new("cool release"),
					Assets: []*github.ReleaseAsset{{Name: new("sbom.spdx.json")}},
				}
				resp := &github.Response{Response: &http.Response{StatusCode: http.StatusOK}}
				repo := &github.Repository{Name: new("link-validator")}
				m.EXPECT().getRepository(mock.Anything, "your-ko", "link-validator").Return(repo, resp, nil)
	...
	tests := []struct {
		...
		},
		{
			...
			setupMock: func(m *mockclient) {
				...
				pkg := &github.Package{Name: new("link-validator")}
...
func Test_handleGist(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			setupMock: func(m *mockclient) {
				gist := &github.Gist{ID: new("your-ko")}
				resp := &github.Response{Response: &http.Response{StatusCode: http.StatusOK}}
		...
		},
		{
			...
			setupMock: func(m *mockclient) {
				comment := &github.GistComment{ID: new(int64(12345))}
				resp := &github.Response{Response: &http.Response{StatusCode: http.StatusOK}}
...
func Test_handleTeams(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			setupMock: func(m *mockclient) {
				team := &github.Team{Name: new("sre")}
				org := &github.Organization{Name: new("mycorp")}
				resp := &github.Response{Response: &http.Response{StatusCode: http.StatusOK}}
...
func Test_handleHttp(t *testing.T) {
	tests := []struct {
		...
		{
			name:               "repository exists and HTTP request succeeds",
			owner:              "your-ko",
			repo:               "link-validator",
			typ:                "wiki",
			url:                "https://github.com/your-ko/link-validator/wiki",
			httpResponseStatus: http.StatusOK,
			httpResponseBody:   "<html><body>Wiki content</body></html>",
			setupMock: func(m *mockclient) {
				repo := &github.Repository{
					ID:       new(int64(123)),
					Name:     new("link-validator"),
			...
			wantErr: nil, // Both repository check and HTTP request should succeed
		},
		{
			name:               "repository exists but HTTP request returns 404",
			owner:              "your-ko",
			repo:               "link-validator",
			typ:                "wiki",
			url:                "https://github.com/your-ko/link-validator/wiki/nonexistent-page",
			httpResponseStatus: http.StatusNotFound,
			httpResponseBody:   "Page not found",
			setupMock: func(m *mockclient) {
				repo := &github.Repository{
					ID:       new(int64(123)),
					Name:     new("link-validator"),
			...
			wantErr: errors.New("not found"), // Expected HTTP validation error
		},
		{
			name:               "repository not found",
			owner:              "your-ko",
			...
			typ:                "wiki",
			url:                "https://github.com/your-ko/nonexistent-repo/wiki",
			httpResponseStatus: http.StatusOK, // HTTP response won't be reached
			httpResponseBody:   "",
			setupMock: func(m *mockclient) {
				err := &github.ErrorResponse{
					Response: &http.Response{StatusCode: http.StatusNotFound},
		...
		{
			name:               "GitHub API error (non-404)",
			owner:              "your-ko",
			repo:               "private-repo",
			typ:                "discussions",
			url:                "https://github.com/your-ko/private-repo/discussions",
			httpResponseStatus: http.StatusOK,
			httpResponseBody:   "",
			setupMock: func(m *mockclient) {
				err := &github.ErrorResponse{
				...
				m.EXPECT().getRepository(mock.Anything, "your-ko", "private-repo").Return(nil, resp, err)
			},
			wantErr: &github.ErrorResponse{
				Response: &http.Response{StatusCode: http.StatusForbidden},
				Message:  "Forbidden",
		...
		{
			name:               "user-level URL: user exists and HTTP request succeeds",
			owner:              "your-ko",
			repo:               "",
			typ:                "projects",
			url:                "https://github.com/users/your-ko/projects/1",
			httpResponseStatus: http.StatusOK,
			httpResponseBody:   "<html><body>Projects</body></html>",
			setupMock: func(m *mockclient) {
				user := &github.User{Login: new("your-ko")}
				resp := &github.Response{Response: &http.Response{StatusCode: http.StatusOK}}
				m.EXPECT().getUser(mock.Anything, "your-ko").Return(user, resp, nil)
			},
			wantErr: nil,
		...
		{
			name:               "user-level URL: user not found",
			owner:              "nonexistent-user",
			repo:               "",
			typ:                "projects",
			url:                "https://github.com/users/nonexistent-user/projects/1",
			httpResponseStatus: http.StatusOK,
			httpResponseBody:   "",
			setupMock: func(m *mockclient) {
				err := &github.ErrorResponse{
		...
		{
			name:               "attestations: repo exists and HTTP request succeeds",
			owner:              "your-ko",
			repo:               "link-validator",
			typ:                "attestations",
			url:                "https://github.com/your-ko/link-validator/attestations/13059584",
			httpResponseStatus: http.StatusOK,
			httpResponseBody:   "<html><body>Attestation</body></html>",
			setupMock: func(m *mockclient) {
				repo := &github.Repository{Name: new("link-validator")}
				resp := &github.Response{Response: &http.Response{StatusCode: http.StatusOK}}
				m.EXPECT().getRepository(mock.Anything, "your-ko", "link-validator").Return(repo, resp, nil)
		...
		{
			name:               "projects: repo exists and HTTP request succeeds",
			owner:              "your-ko",
			repo:               "link-validator",
			typ:                "projects",
		...
		{
			name:               "assets: repo exists and HTTP request succeeds",
			owner:              "your-ko",
			repo:               "link-validator",
			typ:                "assets",
			url:                "https://github.com/your-ko/link-validator/assets/12345/screenshot.png",
			httpResponseStatus: http.StatusOK,
			httpResponseBody:   "<binary content>",
			setupMock: func(m *mockclient) {
				repo := &github.Repository{Name: new("link-validator")}
				resp := &github.Response{Response: &http.Response{StatusCode: http.StatusOK}}
				m.EXPECT().getRepository(mock.Anything, "your-ko", "link-validator").Return(repo, resp, nil)
		...
		{
			name:               "assets: repo exists but asset not found",
			owner:              "your-ko",
			repo:               "link-validator",
			typ:                "assets",
			url:                "https://github.com/your-ko/link-validator/assets/99999/missing.png",
			httpResponseStatus: http.StatusNotFound,
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			ghUrl := &ghURL{enterprise: false, host: "github.com", owner: tt.owner, repo: tt.repo, typ: tt.typ, ref: "", path: "", anchor: "", url: testServer.URL}

			err := handleHttp(context.Background(), mockClient, httpClient, ghUrl)
